...
public class Student {
    ...
    static ArrayList<String> SportsEvents = new ArrayList<>();
    static ArrayList<String> QuizEvents = new ArrayList<>();
    static ArrayList<String> CulturalEvents = new ArrayList<>();
    static ArrayList<String> VolunteerWork = new ArrayList<>();
        ...
        if (count == 0) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                System.out.printf("%-20s%-20s%-10d%-10d%-10d%-10d%-10d%-15.2f%-15d%-15s%-15s%-15s%-15s%n",
                        ...
                        percentage, AssignmentsSubmitted.get(i), SportsEvents.get(i), QuizEvents.get(i),
                        CulturalEvents.get(i), VolunteerWork.get(i));
            }
        }
    }
